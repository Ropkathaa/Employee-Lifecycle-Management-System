...
@document_bp.route("/validate-documents", methods=["POST"])
def validate_documents():
    ...
    and the dynamic frontend redirection route.
    """
    try:
        ...
        # 5. Build Aggregated Response with Explicit Frontend Redirection Directive
        return jsonify({
            "status": "success",
