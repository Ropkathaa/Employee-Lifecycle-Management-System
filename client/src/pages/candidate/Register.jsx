  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 px-4">
      <div className="w-full max-w-md bg-white shadow-sm rounded-xl p-8 border border-slate-100">
        <h1 className="text-2xl font-bold text-brand-700 mb-1">Candidate Registration</h1>
        <p className="text-sm text-slate-500 mb-6">Create your account to start the recruitment process.</p>
